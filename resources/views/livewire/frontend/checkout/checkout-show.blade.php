                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                                ...
                                                @if ($payment->image)
                                                <img src="{{ asset("$payment->image") }}" style="width:50px;height:50px" alt="...">
                                                @endif
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#kpayModal" wire:loading.attr="disabled" class="btn"><h6>{!! $payment->name !!}</h6></a>
                                                @endforeach
                                                {{-- <button type="button" wire:loading.attr="disabled" wire:click="kpay" class="btn btn-warning">Pay Now (Online Payment)</button> --}}
...
<!-- Modal -->
<div class="modal fade" id="kpayModal" tabindex="-1" aria-labelledby="kpayModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="kpayModalLabel">Kpay Scanner</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <img src="/uploads/images/kpayscan.jpg" alt="">
      </div>
