        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="small_description" class="form-control" id="" cols="" rows="4"></textarea>
                </div>
                <div class="mb-3">
                    <label for="">Description</label>
                    <textarea name="description" class="form-control" id="" cols="" rows="4"></textarea>
                </div>
            </div>
                <div class="tab-pane fade p-3" id="seotag-tab-pane" role="tabpanel" aria-labelledby="seotag-tab" tabindex="0">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="meta_description" class="form-control" id="" cols="" rows="4"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="">Meta Keyword</label>
                        <textarea name="meta_keyword" class="form-control" id="" cols="" rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="tab-pane fade p-3" id="color-tab-pane" role="tabpanel" aria-labelledby="image-tab" tabindex="0">
                    <div class="mb-3">
